...
echo "create virsh kubernetes-etcd0 mac=00:16:3e:2f:20:0b ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-etcd1 mac=00:16:3e:2f:20:0c ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-etcd2 mac=00:16:3e:2f:20:0d ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-master mac=00:16:3e:2f:20:0e ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-storage mac=00:16:3e:2f:20:0f ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-worker0 mac=00:16:3e:2f:20:10 ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-worker1 mac=00:16:3e:2f:20:11 ..."
virt-install \
--import \
--debug \
--serial pty \
...
echo "create virsh kubernetes-worker2 mac=00:16:3e:2f:20:12 ..."
virt-install \
--import \
--debug \
--serial pty \
...
--filesystem /var/lib/libvirt/images/kubernetes/kubernetes-master/config/,config-2,type=mount,mode=squash \
--filesystem /var/lib/libvirt/images/kubernetes/kubernetes-master/ssl/,kubernetes-ssl,type=mount,mode=squash \
--network bridge=br0,mac=00:16:3e:2f:20:12,model=virtio
